 ...
 *
 * -----------------------------------------------------------------------------
 * Adapted for SkyRecipes from NotEnoughUpdates (https://github.com/NotEnoughUpdates/NotEnoughUpdates).
 * This file remains under the GNU Lesser General Public License v3.0 or later.
 * All other files in SkyRecipes are licensed under the GNU General Public License v3.0.
 */

package com.github.kdgaming0.skyrecipes.core.util.calculator;
 ...
 *
 * <p>Adapted from NotEnoughUpdates. Supports:</p>
 * <ul>
 *   <li>Binary operators: {@code + - * / ^ x}</li>
 *   <li>Parentheses: {@code ( )}</li>
 *   <li>Postfix multipliers: {@code k m b t s e %}</li>
 *   <li>Variables: {@code $name} or {@code ${name}}</li>
 * </ul>
 */
public final class NeuCalculator {
    ...
    public static BigDecimal evaluate(VariableProvider provider, List<Token> rpnTokens, int precision) throws CalculatorException {
