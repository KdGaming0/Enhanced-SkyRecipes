...
public final class ReforgeTypeResolver {
    ...
    private static final Map<String, List<String>> LORE_TYPE_TO_REFORGE_TYPES = Map.ofEntries(
            ...
            // "EQUIPMENT" is the four equipment slots (necklace/cloak/belt/gloves), not the
            // accessory bag. No reforge data uses "ACCESSORY", so accessories match nothing —
            // the mapping stays only in case talisman reforges ever return.
            Map.entry("ACCESSORY", List.of("ACCESSORY")),
            Map.entry("HATCESSORY", List.of("ACCESSORY")),
            ...
            Map.entry("DUNGEON ACCESSORY", List.of("ACCESSORY")),
            ...
            Map.entry("CARNIVAL MASK", List.of("ACCESSORY")),
